...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        globalManager.ChangeState(GameState.Ready);
        GameStart();
    }
    ...
    private void Update()
    {
        ...
        if (gameTime > maxGameTime)
        {
            ...
            globalManager.ChangeState(GameState.Victory);
        }
    ...
    public void GameStart()
    {
        ...
        UIManager.instance.InitFirstWeaponSelection(playerData.characterId);
